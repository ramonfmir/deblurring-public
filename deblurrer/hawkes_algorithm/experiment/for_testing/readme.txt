Packaging and Deploying experiment
...
2. Installing the experiment Package

A. Go to the directory that contains the file setup.py and the subdirectory experiment. 
...
3. Using the experiment Package

The experiment package is on your Python path. To import it into a Python script or 
   session, execute:
